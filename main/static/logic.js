Moralis.initialize("shxVLeFb4IvOBhYDuiNRNQEGi8HN0BoJSYF0XR6J"); // Application id from moralis.io
Moralis.serverURL = "https://tjhegi0msoxo.usemoralis.com:2053/server"; //Server url from moralis.io
...
async function mainer() {
  ...
  let response = await fetch("static/Images/Images/IO_Test_1.png");
